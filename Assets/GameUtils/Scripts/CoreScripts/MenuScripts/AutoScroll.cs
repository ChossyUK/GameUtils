...
public class AutoScroll : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    {
        // Get Joypad input
        bool joypadInput = Convert.ToBoolean(Input.GetAxisRaw("Vertical"));
        if (m_Selectables.Count > 0)
        {
            if (Input.GetButtonDown("Horizontal") || Input.GetButtonDown("Vertical") || Input.GetButton("Horizontal") || Input.GetButton("Vertical") || joypadInput)
            {
